...
Let's start with the properties. The class has the holistic model as it's first property, no surprise there since this model is the actual feature extractor. 
...
There are many methods within the FeatureExtractor class. Here I will talk through the logic behind the most important methods but I won't necessarily copy paste all of the code. My goal for this section is to explain the flow of data through the program. 
